...
class amigos():
    ...
    def __init__(self):
        ...
        df = ፓንዳ.read_excel("accounts.xlsx")
    ...
    def ወደፌስቡክግባ(self,i):
        ...
        self.driver.find_element(በ .XPATH,"//input[@id='email']").send_keys(self.ስም[i])
        ጊዜ.sleep(1)
        self.driver.find_element(በ .XPATH,"//input[@id='pass']").send_keys(self.ቁልፍ[i])
        ጊዜ.sleep(10)
    ...
    def ጓደኛፈልግ(self):
        ...
        self.እጩጓደኞቼ =self.driver.find_elements(በ .CLASS_NAME,"x1i10hfl.xjbqb8w.x6umtig.x1b1mbwd.xaqea5y.xav7gou.x1ypdohk.xe8uvvx.xdj266r.x11i5rnm.xat24cr.x1mh8g0r.xexx8yu.x4uap5.x18d9i69.xkhd6sd.x16tdsg8.x1hl2dhg.xggy1nq.x1o1ewxj.x3x9cwd.x1e5q0jg.x13rtm0m.x87ps6o.x1lku1pv.x1a2a7pz.x9f619.x3nfvp2.xdt5ytf.xl56j7k.x1n2onr6.xh8yej3")
        ጊዜ.sleep(self.ትንሽጠብቅ2)
